            *> we will do string handling now
            *> inspect, YOU CAN USE TO COUNT CHARS IN STRING
            *> replacing can be used to replace stuff
            *> string and unstring cen be used to concatenate, an split
