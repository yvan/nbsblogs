...
# modularize our setup as a function
# to make new game and loaded file
# setup easier
def setup_game(load_file=None):
    if load_file is None:
        ...
        with open(load_file, 'r') as f:
            ...
            # when saved keys get converted to strings
            # inventory keys are number constants (representing DIRT, etc)
...
# move logic into a main function
if __name__ == '__main__':
    # read in any potential save file and
    # setup the game with that file or defaults
    ...
    # replace instances of state variables with the game state object
    pygame.init()
    ...
    while True:
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                if event.key == K_s:
                    # save current game state dict to disk
