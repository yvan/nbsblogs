...
'''
uniform values are kinda like global values like varying values and can be used to share info
between vert and frag shaders but they dont change (as oppsoed to varying values which do).

uniform values are the same for the entire rendering call.
...
class TestContext(BaseContext):
    ...
    def Render(self, mode=0):
        ...
        #where we actually pass in values to the fog
        glUniform1f(self.UNIFORM_LOCATIONS['end_fog'],15)
        #switched my fog to 0000 from 1111 black to make it
